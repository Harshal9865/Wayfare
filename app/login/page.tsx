        ...
        <div className="w-full max-w-md bg-surface dark:bg-[#1A1A1A] border-2 border-on-surface dark:border-[rgba(250,247,242,0.35)] rounded-[36px] p-8 md:p-10 text-center">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleEmailSubmit} className="space-y-4 text-left">
              ...
              {/* Secondary: One-Click Voyager Access */}
              <button
                type="button"
                onClick={handleInstantVoyagerLogin}
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 bg-primary-container dark:bg-[#1E8C80] text-white dark:text-[#131313] hover:bg-primary py-3 rounded-full border-2 border-on-surface dark:border-[#1E8C80] font-sans text-xs uppercase tracking-wider font-semibold transition-all hover:scale-[1.01] active:scale-95 cursor-pointer disabled:opacity-80 shadow-sm mb-3"
              >
              ...
              <div className="flex items-center gap-3 my-3">
                ...
                <span className="font-sans text-[11px] text-outline dark:text-[rgba(250,247,242,0.4)] uppercase tracking-wider">or with email link</span>
                <div className="flex-1 h-px bg-on-surface/15 dark:bg-white/15" />
              </div>
              ...
              >
                ...
                <span>{loading ? "Dispatching..." : "Send Magic Link"}</span>
              </button>
            </form>
          )}

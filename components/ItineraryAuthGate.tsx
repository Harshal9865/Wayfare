          ...
          {!magicSent ? (
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-4 rounded-full bg-surface-container-lowest dark:bg-[#131313] border-2 border-on-surface dark:border-[rgba(250,247,242,0.3)] text-on-surface dark:text-[#FAF7F2] font-sans text-sm font-semibold hover:bg-surface-container dark:hover:bg-[#1C1B1B] transition-all hover:scale-[1.02] active:scale-95 cursor-pointer mb-4"
              >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-sans text-xs text-outline dark:text-[rgba(250,247,242,0.4)] uppercase tracking-wider">or email</span>
                <div className="flex-1 h-px bg-on-surface/15 dark:bg-[rgba(250,247,242,0.12)]" />
              </div>
